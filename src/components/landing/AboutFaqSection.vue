...
<template>
  <section id="sobre" class="scroll-mt-20 py-20 md:py-28 bg-slate-50">
    <div class="max-w-7xl 2xl:max-w-[90rem] mx-auto px-4 sm:px-6">
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div>
          <div class="mb-8 reveal">
            ...
            <h2 class="font-display text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight mb-4">
              Perguntas <span class="text-emerald-600">frequentes</span>
            </h2>
          ...
          <div class="space-y-3 reveal">
            <div
              ...
              :class="item.open ? 'border-emerald-200 shadow-lg shadow-emerald-500/5' : 'hover:border-emerald-200'"
            >
              <button
                @click="toggle(i)"
        ...
        <div class="relative reveal">
          <div
            class="absolute -inset-4 bg-gradient-to-br from-emerald-100 to-transparent rounded-3xl rotate-2"
          ></div>
          <img
            ...
            loading="lazy"
            class="relative w-full h-[420px] md:h-[520px] object-cover rounded-3xl shadow-2xl shadow-slate-200/60 border border-slate-100"
          />
          <div
            class="absolute -bottom-6 left-6 right-6 sm:right-auto sm:max-w-xs bg-white rounded-2xl p-5 shadow-xl border border-slate-100"
          >
            <div class="flex items-center gap-4">
              <div
                class="w-12 h-12 rounded-xl bg-emerald-100 flex items-center justify-center text-emerald-600 shrink-0"
              >
                <i class="pi pi-clock text-xl"></i>
              </div>
              <div>
                <p class="text-2xl font-extrabold text-slate-900">+10h</p>
                <p class="text-xs text-slate-500">por semana devolvidas ao professor</p>
              </div>
            </div>
          </div>
        </div>
