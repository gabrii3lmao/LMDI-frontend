  ...
  <div class="min-h-screen flex items-center justify-center bg-school-50 dark:bg-lousa-900 font-sans px-6 py-12">
    <div class="z-10 w-full max-w-2xl bg-white dark:bg-lousa-800 p-8 md:p-16 rounded-3xl shadow-sm border border-school-100 dark:border-lousa-700 text-center">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <RouterLink
          to="/"
          class="inline-flex items-center justify-center gap-2.5 px-8 py-3.5 text-sm font-semibold text-white transition-all bg-indigo-600 dark:bg-indigo-500 rounded-xl hover:bg-indigo-800 dark:hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 active:scale-[0.98]"
        >
